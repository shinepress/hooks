...
class DoingActionTest extends TestCase {
	public function testPassthru(): void {
		$globalFunctions = $this->mockGlobalFunctions('doing_action');
		...
		$expected1 = true;
		$actual1 = HookManager::doingAction('action-name');

		$expected2 = false;
		$actual2 = HookManager::doingAction('action-name');
	...
	public function testPreinitialization(): void {
		$expected = false;
		$actual = HookManager::doingAction('action-name');
